...
- **Role-Based Access Control (RBAC):** Roles (e.g., `ADMIN`, `USER`) are encoded in the JWT payload, allowing the backend and frontend to enforce permission-based logic efficiently.
